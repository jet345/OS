...
public class KThread {
	...
	public static void finish() {
		...
		//System.out.println("종료: " + currentThread.toString());
	...
	public static void yield() {
		...
		//System.out.println("내가 양보했습니다     "+currentThread.toString());
	...
	public static void sleep() {
		...
		//System.out.println("**꿀잠***"+currentThread.toString());
	...
	public void ready() {
		...
		//System.out.println("준비** 스레드 : " + toString());
		Lib.assertTrue(Machine.interrupt().disabled());
	...
	private void run() {
		...
		Lib.debug(dbgThread, "Switching from: " + currentThread.toString()
				+ " to: " + toString());
		//System.out.println("상태 바뀜  : "+currentThread.toString()+"에서 "+toString());
	...
	protected void restoreState() {
		...
		//System.out.println("진행 스레드 : "+currentThread.toString());
		Lib.assertTrue(Machine.interrupt().disabled());
		Lib.assertTrue(this == currentThread);
	...
	public static void selfTest() {
		...
		new KThread(new PingTest(1)).setName("자식스레드^").fork();
